    ...
    try {
        ...
        const transporter = nodemailer.createTransport({
            ...
            auth: {
                ...
                pass: process.env.GOOGLE_APP_PASS, // Your email app password
            },
        });
...
`;
        ...
        const mailOptions = {
            ...
            text: `Dear ${guestName},\n\nThank you for booking your stay at${hotelName}. Your reservation is confirmed. Please find the details in the email body.`,
