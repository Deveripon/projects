...
const BookingSection = ({ hotelId }) => {
    ...
    async function handleBookingSubmission(formData) {
        ...
        if (response?.success === true) {
            ...
            console.log(`response from booking section`, response);
        ...
        <>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
                            ...
                            <div className='flex justify-between w-full'>
                                ...
                                {!show ? (
                                    <button
                                        ...
                                        className=' items-end text-zinc-800 underline text-sm'>
                                        Edit
                                    </button>
                                ) : (
                                    <button
                        ...
                        {!data?.user && (
                            <Link href='/login'>
                                <div className='bg-yellow-800 gap-2 flex justify-center items-center text-white p-3 rounded w-full '>
                                    You need to login before proceed{" "}
                ...
                <Suspense fallback={<PricingPreiewCardSkeliton />}>
                    <PreviewSection hotelId={hotelId} />
                </Suspense>
