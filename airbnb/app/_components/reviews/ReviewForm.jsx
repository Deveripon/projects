...
export const ReviewForm = ({ user, onClose, hotelInfo, reviewData }) => {
    ...
    async function submitReview() {
        ...
        try {
            if (!reviewData) {
                ...
                if (response?.success) {
                    toast.success("You have successfully added you review");
                    onClose();
                } else {
                    throw response;
                }
    ...
    return (
        <div className='fixed inset-0 bg-black bg-opacity-80 flex justify-center items-end z-50'>
            <div className='bg-white rounded-t-2xl relative shadow-xl max-w-3xl w-full p-8 transform transition-transform duration-300 translate-y-0'>
                ...
                <header className='text-center mb-8'>
                    <h1 className='text-2xl font-bold text-gray-800'>
                        Review Your Stay at {`"${hotelInfo?.name}"`}
                    </h1>
                    <p className='text-gray-500 mt-2'>{hotelInfo?.location}</p>
                </header>
                ...
                <section className='mb-6'>
                    ...
                    <textarea
                        ...
                        defaultValue={review}
                        rows='8'
                        placeholder='Share your thoughts about the hotel...'
                        className='w-full resize-none p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500'></textarea>
                </section>
                {error && (
